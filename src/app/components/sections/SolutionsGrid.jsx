...
var SolutionsGrid = function () {
    return (<section className={styles.solutionsSection}>
      <div className="container">
        <div className={styles.sectionContainer}>
          <div className={styles.grid}>
            ...
            {solutions.map(function (solution, index) { return (<div key={index} className={styles.solutionBox}>
