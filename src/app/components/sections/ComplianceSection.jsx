...
var ComplianceSection = function () {
    return (<section className={styles.complianceSection}>
      <div className="container">
        <div className={styles.grid}>
          {cardsData.map(function (card, index) { return (<div key={index} className={styles.card}>
              <div className={styles.cardImageWrapper}>
                <Image src={card.imageSrc} alt={card.title} width={250} height={180} className={styles.cardImage}/>
              </div>
