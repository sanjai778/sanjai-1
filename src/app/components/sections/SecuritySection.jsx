...
var SecuritySection = function () {
    return (<section className={styles.securitySection}>
      <div className={"container ".concat(styles.securityContainer)}>
        <div className={styles.iconsColumn}>
          {/* A single composite image representing all security badges and icons */}
          <Image src="/uploads/2025/06/security_soc2_iso_gdpr.png" alt="Security certifications including SOC 2, ISO, and GDPR compliance" width={500} height={300}/>
        </div>
