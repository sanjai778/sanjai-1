      ...
      <div className="bg-gray-50 py-12 lg:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white shadow-xl rounded-2xl p-8 lg:p-12 space-y-8">
              <section>
              ...
              <section>
                <ul className="space-y-4 text-gray-700 list-decimal list-inside">
                  <li>If you wish to cancel your account, notify us at least 15 days before the end of your term (via an email to <a href="mailto:support@onfra.io" className="text-blue-600 hover:underline">support@onfra.io</a>). Upon cancellation, your data is deleted from our servers. Since deletion of all data is final please be sure that you do in fact want to cancel your account before doing so.</li>
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">15 Day No Obligation Cancellation</h2>
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">Monthly Billing, Cancellation, and Refund Policies</h2>
                <div className="space-y-4 text-gray-700">
                  ...
                  <p>All subscriptions monthly, quarterly and yearly renew automatically on their due renewal date according to date of purchase until officially cancelled in writing. Customers may cancel anytime by emailing a notice to: <a href="mailto:support@onfra.io" className="text-blue-600 hover:underline">support@onfra.io</a></p>
                  ...
                  <p>Customers have the ability to upgrade or downgrade their subscription plan for the SaaS services at any time. For any kind of upgrade or downgrade in subscription, customer has to write to <a href="mailto:support@onfra.io" className="text-blue-600 hover:underline">support@onfra.io</a>.</p>
              ...
              <section>
                  <h3 className="text-xl font-bold text-gray-800 mb-3">Non-payment or delay in payment :</h3>
                  <p className="text-gray-700">If a subscriber's account is suspended due to non-payment, the customer will not receive any relief or credit for the suspended period of the service. The subscriber must fully pay any outstanding fees to reactivate their account and resume the subscription. Any missed payments will result in the account's immediate suspension, and the subscriber will be responsible for any accrued charges, including late fees and interest. The subscriber is responsible for keeping their account information up to date, including billing information and payment method, to avoid suspension or interruption of their subscription. The service will resume upon receipt of full payment and will continue according to the original terms of the subscription agreement.</p>
              </section>

              <section>
                  <p className="text-gray-700">These above policies apply to all the SaaS services listed on Onfra unless otherwise noted in the corresponding program materials.</p>
              </section>
